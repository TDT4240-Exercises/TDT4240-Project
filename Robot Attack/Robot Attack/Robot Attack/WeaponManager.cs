...
namespace Robot_Attack
{
    static class WeaponManager
    {
        ...
        static private float shotMinTimer = 0.5f;
        static private float rocketMinTimer = 1.0f;
        ...
        private static void createExplotion(Vector2 location, Vector2 momentum)
        {
        ...
        private static void createNormalShot(Vector2 location, Vector2 velocity)
        {
            AddShot(location, velocity, 0);
            SoundManager.PlayNormalShot();
        }

        private static void createTripleShot(Vector2 location, Vector2 velocity)
        {
            AddShot(location, velocity, 0);
            ...
            SoundManager.PlayTripleShot();
        }

        private static void createRocketShot(Vector2 location, Vector2 velocity)
        {
        ...
        public static void FireWeapon(Vector2 location, Vector2 velocity)
        {
            switch (CurrentWeaponType)
            {
                case WeaponType.Normal:
                    createNormalShot(location, velocity);
                    break;

                case WeaponType.Triple:
                    createTripleShot(location, velocity);
                    break;

                case WeaponType.Rocket:
                    createRocketShot(location, velocity);
                    break;
            }
            shotTimer = 0.0f;
        }
